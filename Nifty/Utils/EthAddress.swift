...
extension EthAddress: Equatable {

    public static func ==(_ lhs: EthAddress, _ rhs: EthAddress) -> Bool {
...
extension EthAddress: BytesConvertible {
